<template>
    <cb-container style="height: calc(100vh-100px);overflow-y: auto;flex-direction: column;" class="containerBox">
        ...
        <cb-container style="height: 100%;flex-direction: column;" class="container-table-Box">
            <table-data
             class="tableBox"
             v-loading="loading"
...
export default {
  ...
  data(){
    ...
    return {
        ...
        detailParams: null,
        detailUri: '/api/beijing/template/dwrTemplateSinglePkService/getTemplateSinglePkByPk',
        detailVisible: null,
        ...
        deleteVisible: false,
        deleteConfirmInfo: '',
        deleteUri: '/api/beijing/template/dwrTemplateSinglePkService/deleteTemplateSinglePkByPks',
        deleteParams: {},
        editParaDefault: {},
  ...
  methods:{
    getData(currentPage, pageSize){
        ...
        let params = {
            templateSinglePk: JSON.stringify(copy),
